...
class MyTubeHollywoodMovies: UIViewController, UIScrollViewDelegate {
    ...
    var genresNames = ["Action", "Comedy", "Crime", "Drama", "Animated", "Horror"]
        ...
        @objc func navigateToMovieDetails(obj:UIButton)
        {
            ...
            let movieDetails = storyboard?.instantiateViewController(withIdentifier: "HollywoodMovieDetails") as! HollywoodMovieDetails
        ...
        func latestMovieDetails()
        {
            ...
            {
                if(tollywoodMovies[x["title"] as! String] == "H")
                {
