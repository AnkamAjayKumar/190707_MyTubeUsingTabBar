...
class MyTubeTollywoodMovies: UIViewController, UIScrollViewDelegate {
    ...
    @objc func navigateToMovieDetails(obj:UIButton)
    {
        ...
        let movieDetails = storyboard?.instantiateViewController(withIdentifier: "TollywoodMovieDetails") as! TollywoodMovieDetails
    ...
    func latestMovieDetails()
    {
        ...
        {
            //JsonData.shared.movieList = tollywoodMovies
            if(tollywoodMovies[x["title"] as! String] == "T")
            {
